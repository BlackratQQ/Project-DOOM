...
interface BlogContentWebsitesProps {
  className?: string;
}

const BlogContentWebsites: React.FC<BlogContentWebsitesProps> = ({
  className,
}) => {
  return (
    <div
...
export default BlogContentWebsites;
